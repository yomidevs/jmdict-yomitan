...
This repository is updated monthly via a GitHub Action and built from the JMdict project files using the [Yomitan-import](https://github.com/themoeway/yomitan-import) tool and a `build_dicts.sh` script provided with the tool.
