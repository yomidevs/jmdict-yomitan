...
This repository is updated monthly via a GitHub Action and is built from the JMdict project files using the [Yomitan Import](https://github.com/themoeway/yomitan-import) tool along with a `build_dicts.sh` script provided with the tool.
